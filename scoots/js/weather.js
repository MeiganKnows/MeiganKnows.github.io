const currentURL = "https://api.openweathermap.org/data/2.5/weather?id=3530103&APPID=2daa9d071489be411f57523f3d6ec725&units=imperial"
...
const forcastURL = "https://api.openweathermap.org/data/2.5/forecast?id=3530103&APPID=2daa9d071489be411f57523f3d6ec725&units=imperial";

fetch(forcastURL)
    .then((response) => response.json())
    .then((jsObject2) => {
        const fiveday = jsObject2.list.filter(x => x.dt_txt.includes("12:00:00"));
